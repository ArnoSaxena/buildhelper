...
public class ItemFillWandAir extends ItemFillWand
{
	...
	public ItemFillWandAir(int itemId)
	{
		super(itemId);
	}
	...
	{
    	this.icons.add(0, iconRegister.registerIcon(Constants.TBH_MODID + ":" + Constants.KEY_AIR_FILL_WAND));
    	this.icons.add(1, iconRegister.registerIcon(Constants.TBH_MODID + ":" + Constants.KEY_AIR_FILL_WAND_CHARGED));
	...
	{
		BlockType usedBlockType = new BlockType(0, 0);
