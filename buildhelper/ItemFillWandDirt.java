...
{
	public ItemFillWandDirt(int itemId)
	{
		super(itemId);
	}
	...
	{
    	this.icons.add(0, iconRegister.registerIcon(Constants.TBH_MODID + ":" + Constants.KEY_DIRT_FILL_WAND));
    	this.icons.add(1, iconRegister.registerIcon(Constants.TBH_MODID + ":" + Constants.KEY_DIRT_FILL_WAND_CHARGED));
	...
	{
		BlockType usedBlockType = new BlockType(Block.dirt.blockID, 0);
